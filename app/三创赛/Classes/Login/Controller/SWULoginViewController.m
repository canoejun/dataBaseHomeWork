...
//    登录请求
    ...
    [manager POST:@"http://192.168.43.198:8080/springmvc_project/login" parameters:paraDic progress:nil success:^(NSURLSessionDataTask * _Nonnull task, id  _Nullable responseObject) {
